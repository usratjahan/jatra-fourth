...
import travelHeader from "../../assets/images/FemaleHeader.png";
...
const MOCK_EVENTS = [
  ...
  },
  {
    ...
    {
    id: 5,
    title: "Cox's Bazar Female Package",
    location: "Cox's Bazar",
    sublocation: "Chittagong",
    description:
      "Family-friendly beach holiday with kids' activities and safe swimming zones.",
...
const Female = () => {
  ...
  useEffect(() => {
    (async () => {
      try {
        setLoading(true);
        // TODO: const res = await fetch('/api/events/female'); const data = await res.json();
        // NOTE: Backend filters WHERE community = 'Female'
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-10 text-center">
          ...
          <p className="text-gray-500 text-base max-w-md mx-auto">
            Safe and curated travel experiences exclusively for female travelers
          </p> */}
